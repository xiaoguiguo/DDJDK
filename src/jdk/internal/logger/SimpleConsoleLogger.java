...
public class SimpleConsoleLogger extends LoggerConfiguration
    ...
    private String getCallerInfo() {
        Optional<StackFrame> frame = new CallerFinder().get();
        if (frame.isPresent()) {
     ...
     */
    static final class CallerFinder implements Predicate<StackFrame> {
    ...
    static final class Formatting {
        ...
        static boolean isFilteredFrame(StackFrame st) {
            ...
            if (Logger.class.isAssignableFrom(st.getDeclaringClass())) {
                return true;
            }
