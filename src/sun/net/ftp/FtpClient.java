...
public abstract class FtpClient implements Closeable {
     ...
     * @return the {@link InputStream} from the data connection
     * @throws IOException if an error occurred during the transmission.
     * @throws FtpProtocolException if the command was refused by the server
     * @see #setRestartOffset(long)
     */
     ...
     * @return the {@link OutputStream} from the data connection.
     * @throws IOException if an error occurred during the transmission.
     * @throws FtpProtocolException if the command was rejected by the server
     */
     ...
     * <p>This method should be called after a successful {@link #connect(InetSocketAddress) }
     * but before calling {@link #login(String, char[]) }.</p>
     *
     * @return this FtpCLient
     * @throws IOException if an error occurred during the transmission.
     * @throws FtpProtocolException if the command was rejected by the server
