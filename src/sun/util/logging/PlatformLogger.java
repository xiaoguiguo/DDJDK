 ...
 * obtained by calling {@link Bridge#convert PlatformLogger.Bridge.convert(}
 * {@link LazyLoggers#getLazyLogger(String, Class)
 ...
 * conditions is met:
 * 1) ServiceLoader.load({@link System.LoggerFinder LoggerFinder.class},
...
public class PlatformLogger {
    ...
    public static synchronized PlatformLogger getLogger(String name) {
        ...
        if (log == null) {
            log = new PlatformLogger(Bridge.convert(
    ...
    public Level level() {
        final ConfigurableBridge.LoggerConfiguration spi =
                ConfigurableBridge.getLoggerConfiguration(loggerProxy);
     ...
     *             System.LoggerFinder} is installed.
     */
    @Deprecated
