 ...
 * By comparison, {@link Process Process} instances were started
 ...
 *
 * <p>
 * A {@link CompletableFuture} available from {@link #onExit}
 ...
 * methods must consistently throw {@link UnsupportedOperationException}.
 * The methods of this class throw {@link UnsupportedOperationException}
...
public interface ProcessHandle extends Comparable<ProcessHandle> {
     ...
     *
     * <p> A {@link Info} instance has accessor methods that return
     ...
     * of the process.
     * The {@link CompletableFuture} provides the ability
     * to trigger dependent functions or actions that may be run synchronously
     * or asynchronously upon process termination.
     * When the process has terminated the CompletableFuture is
     * {@link CompletableFuture#complete completed} regardless
     ...
     * {@link CompletableFuture#isDone done} or to
     ...
     * {@link CompletableFuture#complete completed}
