...
public class MethodHandles {
     ...
     * <tbody>
     * <tr>
     *     <th scope="row">{@link Lookup#findGetter lookup.findGetter(C.class,"f",FT.class)}</th>
     *     <td>{@code FT f;}</td><td>{@code (T) this.f;}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#findStaticGetter lookup.findStaticGetter(C.class,"f",FT.class)}</th>
     *     <td>{@code static}<br>{@code FT f;}</td><td>{@code (T) C.f;}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#findSetter lookup.findSetter(C.class,"f",FT.class)}</th>
     *     <td>{@code FT f;}</td><td>{@code this.f = x;}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#findStaticSetter lookup.findStaticSetter(C.class,"f",FT.class)}</th>
     *     <td>{@code static}<br>{@code FT f;}</td><td>{@code C.f = arg;}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#findVirtual lookup.findVirtual(C.class,"m",MT)}</th>
     *     <td>{@code T m(A*);}</td><td>{@code (T) this.m(arg*);}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#findStatic lookup.findStatic(C.class,"m",MT)}</th>
     *     <td>{@code static}<br>{@code T m(A*);}</td><td>{@code (T) C.m(arg*);}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#findSpecial lookup.findSpecial(C.class,"m",MT,this.class)}</th>
     *     <td>{@code T m(A*);}</td><td>{@code (T) super.m(arg*);}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#findConstructor lookup.findConstructor(C.class,MT)}</th>
     *     <td>{@code C(A*);}</td><td>{@code new C(arg*);}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#unreflectGetter lookup.unreflectGetter(aField)}</th>
     *     <td>({@code static})?<br>{@code FT f;}</td><td>{@code (FT) aField.get(thisOrNull);}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#unreflectSetter lookup.unreflectSetter(aField)}</th>
     *     <td>({@code static})?<br>{@code FT f;}</td><td>{@code aField.set(thisOrNull, arg);}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#unreflect lookup.unreflect(aMethod)}</th>
     *     <td>({@code static})?<br>{@code T m(A*);}</td><td>{@code (T) aMethod.invoke(thisOrNull, arg*);}</td>
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#unreflectConstructor lookup.unreflectConstructor(aConstructor)}</th>
     ...
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#findClass lookup.findClass("C")}</th>
     ...
     * (see {@link Class#getNestHost Class.getNestHost}).
    ...
    class Lookup {
         ...
         *  Module#canRead(Module) readability}.
         *  In conjunction with the {@code PUBLIC} modifier bit, a {@code Lookup}
         ...
         *  Module#isExported(String) exported unconditionally}.
         *  @since 9
         *  @spec JPMS
         *  @see #publicLookup()
         */
         ...
         *  on the {@linkplain MethodHandles#lookup() caller's class} has
         ...
         *  {@linkplain Lookup#dropLookupMode directly cleared}.
         ...
         * {@linkplain ProtectionDomain protection domain} as this lookup's
...
assertEquals("[x, y]", MH_asList.invoke("x", "y").toString());
         ...
         * method handle is equivalent to one produced by
         * {@link MethodHandles#varHandleInvoker} with
...
assertEquals("boojum", (String) catTrace.invokeExact("boo", "jum"));
     ...
     * like {@link Iterable#iterator()}.  In that case, the internal parameter list
     ...
     *                 If non-{@code null}, the handle must return {@link Iterator} or a subtype.
     *                 See above for other constraints.
     * @param init optional initializer, providing the initial value of the loop variable.
     *             May be {@code null}, implying a default initial value.  See above for other constraints.
     * @param body body of the loop, which may not be {@code null}.
