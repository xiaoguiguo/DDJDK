...
public final class StringConcatFactory {
    ...
    private enum Strategy {
        /**
         * Bytecode generator, calling into {@link StringBuilder}.
         */
        BC_SB,
        ...
        /**
         * MethodHandle-based generator, that in the end calls into {@link StringBuilder}.
     ...
     * {@link RecipeElement}-s for generator
     ...
     *     <li>The return type in {@code concatType} is assignable from {@link String}</li>
     * </ul>
     *
     ...
     *                   String}.  When used with {@code invokedynamic},
     ...
     *   from {@link String}, and matches the return type of the
    ...
    private static CallSite doStringConcat(Lookup lookup,
                                           String name,
                                           MethodType concatType,
    ...
    private static final class MethodHandleStringBuilderStrategy {
        ...
        static {
            ...
            if (DEBUG) {
                BUILDER_TO_STRING_CHECKED = lookupStatic(Lookup.IMPL_LOOKUP,
