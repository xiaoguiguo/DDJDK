/**
 * java.lang.invoke 包提供 低级原始的与java虚拟机的交互功能
 * 某些类型由虚拟机进行特殊处理
 ...
 * <p>
 * 在JVM可以执行{invokedynamic}指令之前，必须先链接该指令。链接是通过调用引导方法(bootstrap method)完成的，
 * 该方法被赋予调用的静态信息内容，并且必须产生一个给出调用行为的{java.lang.invoke.CallSite} 。
 * <p>
