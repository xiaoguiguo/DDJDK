 ...
 * {@link Instantiation} object and other information
 ...
 * {@link Reseed} object. This maps to the
 ...
 * {@link NextBytes} object. This maps to the
 ...
 * the requested capability can be {@link Capability#NONE}
 * but the effective value can be {@link Capability#RESEED_ONLY}
 ...
 * {@linkplain Instantiation#getCapability() capability} being
 ...
 * {@link Instantiation} class and additional input is supported
 * through the {@link NextBytes} and
 * {@link Reseed} classes.
 * <p>
 * If a DRBG is not instantiated with a {@link Instantiation}
...
public class DrbgParameters {
    ...
    /**
     * Generates a {@link Instantiation} object.
     *
